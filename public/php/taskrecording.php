      ...
      <div class="row">
        <div class="col-lg-8 col-md-12">
          ...
          <h5>Text messege:</h5>
                    ...
                    $dt = "SELECT * FROM `recording` WHERE id=$num";
...
<div class="container" style="text-align: center;">
          <h4><a href="../core/deleterecording.php?id=<?php echo $row["id"]; ?>">Delete</a></h4>
</div>
          <form method="post" action="../core/editrecording.php">
            ...
            <div class="mb-3">
              <label for="username">Link to firebase</label>
              <div class="input-group">
                <input name="link" type="text" class="form-control" id="title" required value="<?php echo $row['link']; ?>">
              </div>
            </div>
