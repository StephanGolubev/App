...
<!-- form for the text messege -->
          <form method="post" action="../core/createnotification.php">

       <div class="mb-3">
         <label for="username">Name of your new notification</label>
       ...
       <div class="mb-3">
         <label for="text" >The order number</label>
              ...
              <h3>All exersises in this lesson:</h3><br>
        		  <?php
                    ...
                    $link = "http://design-ceramic.epizy.com/public/php/lesson.php?id=".$row['lesson'];
                  		echo "<div id='rows'><h5>This is notification for the lesson <small>'{$row['lesson']}'</small></h5><h6><a href='http://design-ceramic.epizy.com/public/php/editnotification.php?id={$row['id']}'>{$row['name']}</a></h6>THe notification with number: {$row['number']}<p>The text of the notification {$row['text']}</p><div id='user'>";
                }
