  ...
  <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-12">
          ...
          $dt = "SELECT * FROM `text` WHERE id=$num";
...
<div class="container" style="text-align: center;">
  <h4 style="text-align: center;"><a href="../core/deletetext.php?id=<?php echo $row["id"]; ?>">Delete</a></h4>
</div>

          <form method="post" action="../core/edittext.php">
